...
public class SettingsActivity extends com.android.launcher3.SettingsActivity implements PreferenceFragment.OnPreferenceStartFragmentCallback {
    ...
    public static class SettingsFragment extends com.android.launcher3.SettingsActivity.LauncherSettingsFragment
        ...
        public void onCreate(Bundle bundle) {
            ...
            findPreference(OMLSettings.ENABLE_MINUS_ONE_PREF).setTitle(getDisplayGoogleTitle());

            PackageManager packageManager = mContext.getPackageManager();
            try {
                PackageInfo packageInfo = packageManager.getPackageInfo(mContext.getPackageName(), 0);
                findPreference(OMLSettings.APP_VERSION_PREF).setSummary(packageInfo.versionName);
                if (SmartspaceController.get(mContext).cY()) {
                    findPreference(OMLSettings.SMARTSPACE_PREF).setOnPreferenceClickListener(this);
                } else {
        ...
        public boolean onPreferenceChange(Preference preference, final Object newValue) {
            switch (preference.getKey()) {
                ...
                case OMLSettings.SOLID_UI_PREF:
                    ...
                    return true;
                case OMLSettings.SHOW_PREDICTIONS_PREF:
                    if ((boolean) newValue) {
                        return true;
                    }
        ...
        public boolean onPreferenceClick(Preference preference) {
            if (OMLSettings.SMARTSPACE_PREF.equals(preference.getKey())) {
    ...
    public static class SuggestionConfirmationFragment extends DialogFragment implements DialogInterface.OnClickListener {
        public void onClick(final DialogInterface dialogInterface, final int n) {
            if (getTargetFragment() instanceof PreferenceFragment) {
                Preference preference = ((PreferenceFragment) getTargetFragment()).findPreference(OMLSettings.SHOW_PREDICTIONS_PREF);
